    ...
    <section className="relative overflow-hidden bg-brand-dark min-h-[600px] md:min-h-[650px] flex items-center pt-4 md:pt-0">
      ...
      <div className="container mx-auto px-4 relative z-20 flex flex-col md:flex-row items-center gap-8 md:gap-12">
        <div className="w-full md:w-1/2 space-y-4 md:space-y-6 animate-slide-up text-center md:text-left pt-6 md:pt-0 relative z-20">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black leading-[1] italic tracking-tight text-white drop-shadow-lg px-1 pb-1 overflow-visible">
            FEIRÃO DE <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-red-500 inline-block pr-4 pb-1">REPASSE</span> <br/>
            O ANO TODO
          </h1>
        ...
        <div className="w-full md:w-1/2 flex justify-center relative mt-4 md:mt-0">
          ...
          <div className="relative w-full max-w-none md:w-[110%] md:scale-110 lg:scale-125 z-10 animate-fade-in transition duration-1000 hover:scale-[1.15] md:hover:scale-[1.3] hover:-rotate-1">
             <img 
